...
Si quieres usar **tu propio logo** (como el que me pasaste), guárdalo como `assets/logo_source.png`.
El script de build eliminará automáticamente el fondo blanco (pixeles casi blancos) y generará `assets/app_icon.ico`.
...
Esto genera:
- Icono `assets/app_icon.ico` generado automáticamente desde `assets/logo_source.png` (si existe) o icono fallback
